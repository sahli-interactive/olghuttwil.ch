...
const VereinIntro = ({ blok }) => {
    ...
    return (
        <div className="grid grid-cols-12 gap-4 container" {...storyblokEditable(blok)}>
            <div className="mt-40 col-span-12 md:col-span-4 flex flex-col gap-4 bottom-0 left-0">
            ...
            <div className="col-span-12 md:col-span-8 grid grid-cols-8 gap-4 mt-40 md:mt-36">
