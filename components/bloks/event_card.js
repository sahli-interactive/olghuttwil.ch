    ...
    return (
        <>
            <a
                onClick={handleClick}
                href="#"
                className="relative bg-white rounded-br-50 z-10  flex flex-col h-full gap-4 bottom-0 left-0 border-l-4 border-blue-700 hover:drop-shadow-lg hover:border-blue-500 hover:text-blue-500"
            >
                <div className="p-6 md:p-7 flex flex-col gap-3">
                    ...
                    {blok.name && <h3 className="md:text-2xl text-blue-700 font-bold">{blok.name}</h3>}
                </div>
            </a>
