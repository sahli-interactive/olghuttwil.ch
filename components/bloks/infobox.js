    ...
    return (
        <>
            <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-6 mt-6 relative bg-yellow rounded-br-50 z-10 p-7 md:p-8 flex flex-col">
                    <div className="mb-6">
                ...
                <div className="mt-6 col-span-12 md:col-span-6 grid md:grid-cols-6 h-min gap-4">
